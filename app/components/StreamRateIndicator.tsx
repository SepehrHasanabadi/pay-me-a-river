  ...
  */
  const calculateStreamRate = async () => {
    ...
    */
    ...
    aptPerSec += receiverStream ? receiverStream.active.reduce((prev, curr) => prev += curr.amountAptFloat/curr.durationMilliseconds, 0) : 0;
    aptPerSec -= senderStream ? senderStream.reduce((prev, curr) => prev += curr.amountAptFloat/curr.durationMilliseconds, 0) : 0;
    return aptPerSec;
  };
